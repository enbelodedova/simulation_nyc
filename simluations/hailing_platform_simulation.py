...
for i in range(len(fleet_sizes)):
    ...
    for file_path in file_paths:
        ...
        completed_path = RESULTS_DIR / f"hailing_platform_completed_trips_day_{fleet_size}.parquet"
        online_path = RESULTS_DIR / f"hailing_platform_online_cars_day_{fleet_size}.parquet"
        ...
        fleet.to_csv(str(SETUP_DIR / f"hailing_platform_fleet_final_{fleet_size}.csv"), index=False)
